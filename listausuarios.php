...
<head>
    ...
    <?php
            ...
            $usuarios = tblAdministradores::getAllUsuarios();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel-heading"> 
                                    <h3 class="panel-title" align="center">Lista De Usuarios Registradas</h3>         
                                </div>
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table datatable table-bordered table-striped table-actions">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" width="150">Numero Cedula</th>
                                                    <th class="text-center">Nombres Y Apellidos</th>
                                                    <th class="text-center" width="110">Telefono</th>
                                                    <th class="text-center" width="160">Dirección</th>
